...
public class carunginecaymen2 : MonoBehaviour
{
    ...
    void nnnn()
    {
        ...
        else
        {
            ...
            if (currectNode == 60 && pathcount == 1)
            {
                ...
                if (chosenNumber == 0)
                {
                    leftsidecaymen2.SetAutoToggle(true);

                }
            }
            if (currectNode == 4 && pathcount == 3)
            {
                leftsidecaymen2.SetAutoToggle(false);
            ...
            if (currectNode == 67 && pathcount == 3)
            {
                chosenNumber = forchoosennumber();
                if (chosenNumber == 0)
                    rightsidecaymen2.SetAutoToggle(true);
            }

            if (currectNode == 4 && pathcount == 3)
            {
                rightsidecaymen2.SetAutoToggle(false);
