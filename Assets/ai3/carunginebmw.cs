...
public class carunginebmwai : MonoBehaviour
{
  ...
  void nnnn()
  {
    ...
    else
    {
      ...
      if (currectNode == 60 && pathcount == 1)
      {
        ...
        if (chosenNumber == 0)
        {
          leftsidebmw.SetAutoToggle(true);

        }
      }
      if (currectNode == 4 && pathcount == 3)
      {
        leftsidebmw.SetAutoToggle(false);
      ...
      if (currectNode == 67 && pathcount == 3)
      {
        chosenNumber = forchoosennumber();
        if (chosenNumber == 0)
          rightsidebmw.SetAutoToggle(true);
      }

      if (currectNode == 4 && pathcount == 3)
      {
        rightsidebmw.SetAutoToggle(false);
