...
public class carunginecaymen : MonoBehaviour
{
  ...
  void nnnn()
  {
    ...
    else
    {
      ...
      //Before reaching a point of crossing paths.
      if (currectNode == 60 && pathcount == 1)
      {
        chosenNumber = forchoosennumber();
        if (chosenNumber == 0)
        {
          leftsidecaymen.SetAutoToggle(true);
        }
      }
      if (currectNode == 4 && pathcount == 3)
      {
        leftsidecaymen.SetAutoToggle(false);
      }
      ...
      if (currectNode == 67 && pathcount == 3)
      {
        chosenNumber = forchoosennumber();
        if (chosenNumber == 0)
          rightsidecaymen.SetAutoToggle(true);
      }

      if (currectNode == 4 && pathcount == 3)
      {
        rightsidecaymen.SetAutoToggle(false);
      ...
      // the circle
      if (currectNode == 103 && pathcount == 2)
      {
        circlef = 2;
      ...
      if (currectNode == 175 && pathcount == 1)
      {
        circlef = 3;
        chosenNumber = forchoosennumbercircle();
  ...
  void senseores()
  {
    ...
    if (Physics.Raycast(sensorStartPos, transform.forward, out hit, sensoresleanth))
    {
      ...
      //AI car detecting the traffic light.
