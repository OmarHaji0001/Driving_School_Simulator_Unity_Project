...
public class carungine : MonoBehaviour
{
  ...
  void nnnn()
  {
    ...
    else
    {
      ...
      if (currectNode == 60 && pathcount == 1)
      {
        ...
        if (chosenNumber == 0)
        {
          leftsideai1.SetAutoToggle(true);

        }
      }
      if (currectNode == 4 && pathcount == 3)
      {
        leftsideai1.SetAutoToggle(false);
      ...
      if (currectNode == 67 && pathcount == 3)
      {
        chosenNumber = forchoosennumber();
        if (chosenNumber == 0)
          rightsideai1.SetAutoToggle(true);
      }
      ...
      if (currectNode == 15 && pathcount == 3)//done2
      {
        chosenNumber = forchoosennumber();
        if (chosenNumber == 0)
          leftsideai1.SetAutoToggle(true);
      }
      if (currectNode == 164 && pathcount == 1)//done
      {
        leftsideai1.SetAutoToggle(false);
